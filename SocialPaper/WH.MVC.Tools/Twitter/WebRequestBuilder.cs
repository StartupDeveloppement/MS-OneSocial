...
namespace WH.MVC.Tools.Twitter
{
    /// <summary>
    ...
    public sealed class WebRequestBuilder
    {
        ...
        public TwitterAuthTokens Tokens { private get; set; }
        ...
        public WebRequestBuilder(Uri requestUri, HTTPVerb verb, TwitterAuthTokens tokens, string userAgent = "")
